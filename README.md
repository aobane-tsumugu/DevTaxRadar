...
Global Build Week Community Event - Tokyoの3時間ハッカソンで制作したMVPです。履歴走査・配賦・ローカル保存・2画面UI・税務候補エンジンを実装済みですが、申告内容を確定する製品ではありません。イベントは[こちら](https://luma.com/uj22d2rs)です。
